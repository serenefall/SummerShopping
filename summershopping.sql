...
INSERT INTO Customer (Customer_id, Customer_Name, Phone#, Billing_address, Shipping_address) values (894, 'Delbert Park', '(437) 5130996', '99431 Almo Trail', '99431 Almo Trail');
INSERT INTO Customer (Customer_id, Customer_Name, Phone#, Billing_address, Shipping_address) values (331, 'Becky Maxwell', '(573) 8030653', '53 Portage Crossing', '53 Portage Crossing');
...
INSERT INTO VIP_1 (VIP_ID, VIP_Points) values (89, 7);
...
INSERT INTO VIP_2 (Customer_id, VIP_ID, Annual_fee) values (516, 46, 20);
INSERT INTO VIP_2 (Customer_id, VIP_ID, Annual_fee) values (948, 21, 20);
...
INSERT INTO Products (Product_ID, Category, Manufacturer, Product_Name) values (79301, 'Kids', 'Zboncak, Rice and Bins', 'Muffin Batt - Ban Dream Zero');
INSERT INTO Products (Product_ID, Category, Manufacturer, Product_Name) values (75637, 'Industrial', 'Von, Metz and Wuckert', 'Snapple - Iced Tea Peach');
...
INSERT INTO Seller (Seller_Name, SIN, Seller_ID, Address, Phone#) values ('Thorin Trembley', 854479275, 3356, '72399 Warner Park', '(575) 4504131');
INSERT INTO Seller (Seller_Name, SIN, Seller_ID, Address, Phone#) values ('Casie Melville', 810896693, 1553, '8 Claremont Point', '(464) 9851443');
...
INSERT INTO PutOrder (Status, Payment_method, Date_placed, Shipping_date, Arrival_date, VIP_points_used, Order_number , Product_ID, Customer_id, Seller_ID, Quantity) values ('Completed', 'switch', '2017-5-13', '2017-5-14', '2017-5-18', 6, 62089060, 13511, 896, 1284, 1);
INSERT INTO PutOrder (Status, Payment_method, Date_placed, Shipping_date, Arrival_date, VIP_points_used, Order_number , Product_ID, Customer_id, Seller_ID, Quantity) values ('Completed', 'paypal', '2017-2-11', '2017-2-12', '2017-2-16', 8, 62735978, 10135, 274, 7458, 2);
...
INSERT INTO Rate (Rating, Customer_id, Seller_ID, Product_ID, Order_number) values (3, 567, 7928, 30874,64789060);
INSERT INTO Rate (Rating, Customer_id, Seller_ID, Product_ID, Order_number) values (5, 678, 7151, 77682,62088100);
...
INSERT INTO Has (Product_ID, Seller_ID, Quantity, Price) values (21248, 8845, 124, '$196.76');
...
INSERT INTO Has (Product_ID, Seller_ID, Quantity, Price) values (13776, 8548, 126, '$112.81');
INSERT INTO Has (Product_ID, Seller_ID, Quantity, Price) values (86410, 6013, 156, '$169.82');
